...
<body>
<div id="sidebar">
    <center><img src="../img/titlefindbranco.png"></center>
    <center><img src="../img/titlechat.png"></center>
</div>
<div id="primary">
    <div id="log">
    ...
    <div id="composer">
        <form name="form_message" id="form_message" method="post" action="set_message.ajax.php">
          <input name="nickname" type="hidden" id="nickname" value="<?php echo $_SESSION['nome']; ?>">
