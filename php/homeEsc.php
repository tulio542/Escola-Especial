        ...
        <div class="alinhar">   
            <div class="caixa">
                <p>
                    ...
                    Após algum administrador verificar se as informações inseridas são confiaveis e seguras, ele irá ativar seu perfil para que seu colégio ajude milhares de pessoas!
                </p>
            </div>
        </div>
        ...
        <div class="alinhar">   
            <div class="caixa">
                <p>
                    ...
                    O propósito do nosso site é ajudar pais e responsáveis a encontrar colégio que estejam adeptas a seus filhos!
                    Um administrador já verificou suas informações!
                    <br>
                    Agora seu perfil esta ativo e aparecerá na lista de escolas!
                </p>
            </div>
        </div>
        <div style="height: 150px; overflow: hidden;" id="rodapeCad"><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;"><path d="M0.00,49.98 C149.99,150.00 349.20,-49.98 500.00,49.98 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #00a9ba;"></path></svg></div>
