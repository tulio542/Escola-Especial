...
<body>
    ...
    <div class="container" style="margin-top: 40px" id="container">
        ...
        <form action="atualizar_escola.php" method="post" style="margin-top: 20px">
            <?php 
            
            $sql = "SELECT * FROM `escola` WHERE escola_id = $id";
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="id" value="<?php echo $id_usuario?>" disabled>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="acessibilidade" value="<?php echo $acessibilidade?>">
            </div>
