...
if(isset($_SESSION['usuarioEmail']) || isset($_SESSION['usuarioAdmin'])){
...
?>
    ...
    <div class="container" style="margin-top: 40px">
        ...
        <table class="table" id="table_id">
            <thead>
                <tr>
                    <th scope="col" style="min-width: 120px;">Nome da Escola</th>
<!--                    <th scope="col">Email</th>-->
            ...
            while ($array = mysqli_fetch_array($busca)) {
                ...
                $id_usuario = $array['escola_id'];
                $endereco = $array['endereco_id']; 
                $nome = $array['nome'];
        ...
        ?>
            <tr>
                ...
                <td style="vertical-align: inherit;"> <?php echo $acessibilidade ?> </td>
                <td style="vertical-align: inherit;">
                    <center>
                        <a href="listar_endereco.php?id=<?php echo $endereco ?>" role="button"
                            class="btn btn-warning btn-sm">&nbsp; Endereço</a>
                            <a href="editar_escola.php?id=<?php echo $id_usuario ?>" role="button"
