...
<body>
    ...
    <div class="container" style="margin-top: 40px" id="container">
        ...
        <form action="atualizar_portador.php" method="post" style="margin-top: 20px">
            <?php 
            
            $sql = "SELECT * FROM `portador` WHERE portador_id = $id";
            $buscar = mysqli_query($conn,$sql);
            while ($array = mysqli_fetch_array($buscar)) {
                $id = $array['portador_id'];
                $nome = $array['nomedef']; 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="deficiencia" value="<?php echo $deficiencia?>">
            </div>
